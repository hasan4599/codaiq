        ...
        <div className="container mx-auto">
          ...
          >
            ...
            <div className="flex justify-center mb-20">
              <div className="glass-layer p-2 rounded-full inline-flex gap-2">
                <button
                  ...
                  className={`px-8 py-3 rounded-full text-lg font-medium ${
                    !isYearly 
                      ...
                      : 'bg-transparent text-gray-300 hover:bg-gray-800/30'
                  } transition-all`}
                >
                  Monthly Billing
                </button>
            ...
            <div className="grid lg:grid-cols-3 gap-8">
              {pricingPlans.map((plan, i) => (
                <motion.div
                  ...
                  viewport={{ once: true, margin: "-100px" }}
                  transition={{ delay: i * 0.2 }}
                  className={`glass-layer p-8 rounded-3xl border-2 relative overflow-hidden ${
                    plan.popular 
                ...
                >
                  {plan.popular && (
                    <div className="absolute top-0 right-0 bg-purple-400 text-gray-900 px-6 py-2 rounded-bl-xl text-sm font-bold">
                      Most Popular
                    </div>
                  )}
            ...
            <motion.div
              ...
              whileInView={{ scale: 1 }}
              viewport={{ once: true }}
              className="glass-layer mt-20 p-8 rounded-3xl border-2 border-purple-400/30 relative overflow-hidden"
            >
              <div className="absolute inset-0 bg-gradient-to-r from-purple-400/5 to-blue-400/5 -z-10" />
              ...
              <div className="text-center max-w-2xl mx-auto">
                ...
                <h3 className="text-4xl font-bold mb-4">Forever Free</h3>
                ...
                <div className="grid md:grid-cols-2 gap-6 text-left mb-12">
                  <div className="glass-layer p-6 rounded-xl">
                    <h4 className="text-lg font-bold mb-2">Included Features</h4>
