          ...
          <nav className="flex flex-col gap-6">
            {['Features', 'How It Works', 'Templates', 'Pricing', 'Academy'].map(item => (
              <a
                ...
                className="glass-layer p-6 rounded-2xl text-2xl"
              >
                {item}
              </a>
            ))}
            ...
            <div className="glass-layer p-8 rounded-3xl border border-blue-400/20 relative overflow-hidden">
              ...
              <div className="flex gap-4">
                ...
                <button
                  ...
                  className="bg-gradient-to-r from-blue-400 to-purple-500 w-16 h-16 rounded-2xl flex items-center justify-center"
                >
            ...
            <div className="flex items-center justify-center h-full p-8">
              {!aiOutput && !isGenerating && (
                <div className="text-center space-y-4">
                  <FontAwesomeIcon icon={faLayerGroup} className="text-purple-400 text-4xl" />
            ...
            {[
              ...
              <div key={i} className="relative group">
                ...
                <div className="glass-feature p-10 flex flex-col items-start border border-white/10 rounded-2xl bg-gradient-to-b from-white/5 to-white/[0.01] group-hover:border-white/20 transition-all duration-300">
                  ...
                  >
                    <FontAwesomeIcon icon={feature.icon} className="text-white text-2xl drop-shadow-xl" />
                  </div>
        ...
        <div className="container mx-auto">
          <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }}>
            ...
            <div className="grid md:grid-cols-4 gap-8 relative">
              <div className="hidden md:block absolute top-24 left-0 right-0 h-2 bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 w-3/4 mx-auto rounded-full opacity-50" />
              ...
              {[
                ...
                >
                  <div className={`absolute -top-6 left-1/2 -translate-x-1/2 w-12 h-12 rounded-2xl bg-gradient-to-r ${step.color} flex items-center justify-center text-white font-bold text-xl shadow-xl`}>
                    {step.step}
                  </div>
                  <div className={`w-16 h-16 ${i === 1 ? 'mt-4' : 'mt-8'} mx-auto mb-6 rounded-2xl bg-gradient-to-r ${step.color} bg-opacity-20 flex items-center justify-center`}>
                    <FontAwesomeIcon icon={step.icon} className={`text-2xl ${i === 0 ? 'text-blue-400' : i === 1 ? 'text-purple-400' : i === 2 ? 'text-pink-400' : 'text-green-400'}`} />
                  </div>
          ...
          <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }}>
            ...
            <div className="grid lg:grid-cols-3 gap-8">
              {[
                ...
                >
                  <div className="p-8 rounded-3xl border-2 bg-gradient-to-b from-white/5 to-white/[0.01] border-white/10 group-hover:border-white/20 transition-all">
                    {plan.popular && (
                      <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-gradient-to-r from-purple-400 to-blue-400 text-gray-900 px-6 py-1 rounded-full text-sm font-bold">
                        Most
