    ...
    return (
        <>
            <motion.aside
                ...
                className="border-r border-gray-800/50 bg-gray-900/50 backdrop-blur-xl h-full w-[300px] flex flex-col justify-between py-6 px-4 text-zinc-200 fixed top-0 right-0 z-50"
            >
                <div className="space-y-4">
                    <div className="text-lg font-bold px-2 text-zinc-100 flex w-full items-center justify-between">
                        <h1>Codaiq</h1>
